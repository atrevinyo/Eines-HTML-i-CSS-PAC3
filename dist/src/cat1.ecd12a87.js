...
})({"hYhGe":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "27d37567ecd12a87";
"use strict";
...
},{}],"gFLGT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _viewerjs = require("viewerjs");
var _viewerjsDefault = parcelHelpers.interopDefault(_viewerjs);
const zoomImatge = (id)=>{
    const viewer = new _viewerjsDefault.default(document.getElementById(id), {
        viewed () {
            viewer.zoomTo(1);
        }
    });
...
},{"viewerjs":"bZhDc","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"bZhDc":[function(require,module,exports) {
(function(global, factory) {
   ...
   */ function addListener(element, type, listener) {
        ...
        type.trim().split(REGEXP_SPACES).forEach(function(event) {
            if (options.once && !onceSupported) {
                var _element$listeners = element.listeners, listeners = _element$listeners === void 0 ? {
                } : _element$listeners;
   ...
   */ function getImageNaturalSizes(image, options, callback) {
        ...
        forEach(options.inheritedAttributes, function(name) {
            ...
            if (value !== null) newImage.setAttribute(name, value);
        });
   ...
   */ function getPointersCenter(pointers) {
    ...
    var render = {
        ...
        initList: function initList() {
            ...
            if (options.transition) addListener(element, EVENT_VIEWED, function() {
    ...
    var events = {
        bind: function bind() {
            ...
            if (options.zoomable && options.zoomOnWheel) addListener(viewer, EVENT_WHEEL, this.onWheel = this.wheel.bind(this), {
                passive: false,
                capture: true
            });
        ...
        unbind: function unbind() {
            ...
            if (options.zoomable && options.zoomOnWheel) removeListener(viewer, EVENT_WHEEL, this.onWheel, {
                passive: false,
                capture: true
            });
    ...
    var handlers = {
        ...
        keydown: function keydown(event) {
            ...
            switch(keyCode){
                // Enter
                case 13:
                    if (this.viewer.contains(event.target)) this.click(event);
                    break;
            }
        ...
        pointerdown: function pointerdown(event) {
            ...
            if (options.zoomOnTouch && options.zoomable && Object.keys(pointers).length > 1) action = ACTION_ZOOM;
        ...
        pointermove: function pointermove(event) {
            ...
            event.preventDefault();
            if (event.changedTouches) forEach(event.changedTouches, function(touch) {
                assign(pointers[touch.identifier] || {
                }, getPointer(touch, true));
            });
            else assign(pointers[event.pointerId || 0] || {
        ...
        pointerup: function pointerup(event) {
            ...
            if (!action) return;
            event.preventDefault();
            if (options.transition && (action === ACTION_MOVE || action === ACTION_ZOOM)) addClass(this.image, CLASS_TRANSITION);
            ...
            if (IS_TOUCH_DEVICE && action !== ACTION_ZOOM && pointer && Date.now() - pointer.timeStamp < 500) {
                ...
                if (options.toggleOnDblclick && this.viewed && event.target === this.image) {
                    ...
                    if (options.backdrop && options.backdrop !== 'static' && event.target === this.canvas) // This timeout will be cleared later when a native click event is triggering
     ...
     */ show: function show() {
            ...
            if (isFunction(options.show)) addListener(element, EVENT_SHOW, options.show, {
                once: true
            });
     ...
     */ hide: function hide() {
            ...
            if (isFunction(options.hide)) addListener(element, EVENT_HIDE, options.hide, {
                once: true
            });
            ...
            if (options.transition && !immediate) {
                ...
                this.transitioning = {
                    abort: function abort() {
                        ...
                        else if (hasClass(viewer, CLASS_TRANSITION)) removeListener(viewer, EVENT_TRANSITION_END, onViewerTransitionEnd);
                    }
     ...
     */ view: function view() {
            ...
            image.src = url;
            image.alt = alt;
            if (isFunction(options.view)) addListener(element, EVENT_VIEW, options.view, {
                once: true
            });
     ...
     */ moveTo: function moveTo(x) {
            ...
            if (this.viewed && !this.played && options.movable) {
                ...
                if (changed) {
                    if (isFunction(options.move)) addListener(element, EVENT_MOVE, options.move, {
                        once: true
                    });
                    ...
                    this.renderImage(function() {
                        _this3.moving = false;
                        if (isFunction(options.moved)) addListener(element, EVENT_MOVED, options.moved, {
                            once: true
                        });
     ...
     */ rotateTo: function rotateTo(degree) {
            ...
            if (isNumber(degree) && this.viewed && !this.played && options.rotatable) {
                ...
                if (isFunction(options.rotate)) addListener(element, EVENT_ROTATE, options.rotate, {
                    once: true
                });
                ...
                this.renderImage(function() {
                    ...
                    if (isFunction(options.rotated)) addListener(element, EVENT_ROTATED, options.rotated, {
                        once: true
                    });
     ...
     */ scale: function scale(scaleX) {
            ...
            if (this.viewed && !this.played && options.scalable) {
                ...
                if (changed) {
                    if (isFunction(options.scale)) addListener(element, EVENT_SCALE, options.scale, {
                        once: true
                    });
                    ...
                    this.renderImage(function() {
                        ...
                        if (isFunction(options.scaled)) addListener(element, EVENT_SCALED, options.scaled, {
                            once: true
                        });
     ...
     */ zoomTo: function zoomTo(ratio) {
            ...
            if (isNumber(ratio) && this.viewed && !this.played && (_zoomable || options.zoomable)) {
                ...
                this.renderImage(function() {
                    ...
                    if (isFunction(options.zoomed)) addListener(element, EVENT_ZOOMED, options.zoomed, {
                        once: true
                    });
     ...
     */ play: function play() {
            ...
            var element = this.element, options = this.options;
            if (isFunction(options.play)) addListener(element, EVENT_PLAY, options.play, {
                once: true
            });
        ...
        stop: function stop() {
            ...
            var element = this.element, options = this.options;
            if (isFunction(options.stop)) addListener(element, EVENT_STOP, options.stop, {
                once: true
            });
        ...
        full: function full() {
            ...
            if (this.viewed) this.initImage(function() {
                _this9.renderImage(function() {
                    if (options.transition) setTimeout(function() {
     ...
     */ toggle: function toggle() {
            ...
            if (this.imageData.ratio === 1) this.zoomTo(this.imageData.oldRatio, true, _originalEvent);
            else this.zoomTo(1, true, _originalEvent);
            return this;
        },
        // Reset the image to its initial state
        reset: function reset() {
            if (this.viewed && !this.played) {
                this.imageData = assign({
        ...
        update: function update() {
            ...
            forEach(isImg ? [
                ...
                if (isFunction(options.filter)) {
                    if (options.filter.call(_this12, image)) images.push(image);
                } else if (_this12.getImageURL(image)) images.push(image);
            });
                ...
                forEach(this.items, function(item, i) {
                    ...
                    if (image && img) {
                        if (image.src !== img.src // Title changed (#408)
                         || image.alt !== img.alt) changedIndexes.push(i);
                    } else changedIndexes.push(i);
                });
                setStyle(this.list, {
                    width: 'auto'
                });
    ...
    var others = {
        ...
        enforceFocus: function enforceFocus() {
            ...
            addListener(document, EVENT_FOCUSIN, this.onFocusin = function(event) {
                ...
                if (target !== document && target !== viewer && !viewer.contains(target) // Avoid conflicts with other modals (#474)
                 && (target.getAttribute('tabindex') === null || target.getAttribute('aria-modal') !== 'true')) viewer.focus();
            });
        },
        ...
        shown: function shown() {
            ...
            if (isFunction(options.shown)) addListener(element, EVENT_SHOWN, options.shown, {
                once: true
            });
        ...
        hidden: function hidden() {
            var element = this.element, options = this.options, viewer = this.viewer;
            if (options.fucus) this.clearEnforceFocus();
            this.fulled = false;
            this.viewed = false;
            this.isShown = false;
            this.close();
            ...
            this.hiding = false;
            if (!this.destroyed) {
                if (isFunction(options.hidden)) addListener(element, EVENT_HIDDEN, options.hidden, {
                    once: true
                });
     ...
     */ function Viewer(element) {
            ...
            this.options = assign({
            }, DEFAULTS, isPlainObject(options) && options);
            this.action = false;
            this.fading = false;
            this.fulled = false;
            this.hiding = false;
                ...
                value: function init() {
                    ...
                    if (options.inline) {
                        ...
                        forEach(images, function(image) {
                            ...
                            else addListener(image, EVENT_LOAD, progress, {
                                once: true
                            });
                        });
                    } else addListener(element, EVENT_CLICK, this.onStart = function(_ref) {
                        var target = _ref.target;
                        if (target.localName === 'img' && (!isFunction(options.filter) || options.filter.call(_this, target))) _this.view(_this.images.indexOf(target));
                    });
                }
            },
            {
                ...
                value: function build() {
                    ...
                    if (options.keyboard) button.setAttribute('tabindex', 0);
                    if (options.backdrop) {
                        addClass(viewer, "".concat(NAMESPACE, "-backdrop"));
                        if (!options.inline && options.backdrop !== 'static') setData(canvas, DATA_ACTION, 'hide');
                    }
                    if (isString(options.className) && options.className) // In case there are multiple class names
                    ...
                    if (options.toolbar) {
                        ...
                        forEach(custom ? options.toolbar : BUTTONS, function(value, index) {
                            ...
                            if ([
                                'small',
                                'large'
                            ].indexOf(size) !== -1) addClass(item, "".concat(NAMESPACE, "-").concat(size));
                    ...
                    if (options.inline) {
                        ...
                        if (window.getComputedStyle(parent).position === 'static') setStyle(parent, {
                            position: 'relative'
                        });
...
},{}]},["hYhGe","gFLGT"], "gFLGT", "parcelRequirea87c")

//# sourceMappingURL=cat1.ecd12a87.js.map
